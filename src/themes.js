export const themes = {
    ...
    about: {
      ...
      aboutMeParagraph: `
        <p>Hi, I'm Derek, a Frontend Developer dedicated to crafting exceptional user interfaces and experiences.</p>
         ...
         Driven by a passion for clean and intuitive design, I ensure that every interface I create not only meets but exceeds user expectations.
         <p>Best regards,
      `,
    },
    contact: {
  ...
  Spanish: {
    ...
    about: {
      ...
      Impulsado por una pasión por el diseño limpio e intuitivo, me aseguro de que cada interfaz que creo no solo cumpla, sino que supere las expectativas del usuario.
      <p>Saludos cordiales,
      `,
    },
    contact: {
